...
public:
   ...
   bool isEmpty();
   void Delete_Tree(TreeNode* T_Node);
   bool Insert(DBentry* newEntry,TreeNode* T_Node);
   TreeNode* Search(string name,TreeNode* T_Node, bool &Found);
   TreeNode* Search_Parent(string name,TreeNode* T_Node, bool &Found ,char &Direction);
   TreeNode* Max_Left_Tree(TreeNode* T_Node);
   void Count_Active(TreeNode* T_Node, int &Active_num)const;
